...
public class FATSuite {
    ...
    @ClassRule
    public static RepeatTests r = RepeatTests.with(FeatureReplacementAction.NO_REPLACEMENT().liteFATOnly())
                    .andWith(FeatureReplacementAction.EE8_FEATURES().liteFATOnly())
